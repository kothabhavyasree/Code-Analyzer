...
def create_prompt_node(state:CodeState)-> CodeState:
    """Create a prompt node that prepares the code for analysis"""
    query = state["query"]
...
-Expalin reasonings step by step
